...
const Login_Signup = () => {
  ...
  const handleonsubmitsignup = async (data) => {
    const res = await signIn("credentials", {
      name: data.name,
      age: data.age,
      email: data.email,
  ...
  return (
    <>
      {login && (
        <main className="h-screen min-h-[755px]">
          <button onClick={()=>router.push("/")} className="p-2 absolute left-7 top-7 cursor-pointer">
            <img src="svgs/close.svg" alt="Close" />
          </button>
          <button
            onClick={() => router.push("?login=false")}
            className="uppercase absolute right-7.5 top-7.5  border-2 active:mt-0.5 hover:brightness-90 bg-white active:border-b-2 p-2.5 text-[#1CB0F6] font-extrabold border-b-4 cursor-pointer  border-[#e5e5e5] px-6 rounded-xl"
          >
            Sign up
          </button>

          <section className="w-[375px] max-[700px]:w-full max-[700px]:px-8 mx-auto flex flex-col h-full items-center py-8 justify-center">
            <form
              className="w-full h-fit flex flex-col gap-5"
              onSubmit={handleSubmit(handleonsubmitlogin)}
            >
              <h1 className="font-extrabold text-[#3C3C3C] text-center py-4 text-2xl">
                Log in
              </h1>
              ...
              <div>
                ...
                />
                {errors.loginemail && (
                  <p className="text-red-500 font-semibold flex gap-1 items-center justify-start mt-1">
                    <img className="w-6" src="svgs/error.svg" alt="Error: " />
            ...
            <p className="font-semibold text-sm text-[#afafaf] text-center mt-9">
      ...
      {!login && (
        <main className="h-screen min-h-[870px]">
          <button onClick={()=>router.push("/")} className="p-2 absolute left-7 top-7 cursor-pointer">
            <img src="svgs/close.svg" alt="Close" />
          </button>
          <button
          ...
          <section className="w-[375px] max-[700px]:w-full max-[700px]:px-8 mx-auto flex flex-col h-full items-center py-8 justify-center">
            <form
              className="w-full h-fit flex flex-col gap-5"
              onSubmit={handleSubmit(handleonsubmitsignup)}
            >
              <h1 className="font-extrabold text-[#3C3C3C] text-center py-4 text-2xl">
                Create your profile
              </h1>
              ...
              <div>
                ...
                {!errors.age && (
                  <p className="font-semibold px-0.5 text-base text-[#777777]">
