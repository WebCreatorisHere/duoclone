  ...
  return (
    <section className='flex justify-center items-center h-screen overflow-y-hidden bg-[#f7f9f9]'>
       ...
       <div className='w-[50%] flex flex-col justify-center h-full pb-20 items-center gap-10'>
          ...
          <button onClick={()=>router.push("/login-signup?login=true")} className='uppercase cursor-pointer border-2 border-b-4 text-[#1CB0F6] font-extrabold rounded-xl border-[#E5E5E5] p-2.5 px-16'>I Already have an account</button>
          </div>
